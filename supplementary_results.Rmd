...
source("src/trend_plots_function.R")
```

```{r load-data}
load("data/All_BALA_data.RDA")
load("data/conservation_spp.RDA")


# long processes, data is saved and loaded
if (file.exists("data/all_trend_results.RDA")) {
    load("data/all_trend_results.RDA")
} else {
    source("src/trends_wrapper.R")
}

if (file.exists("data/simulation_df.RDA")) {
    load("data/simulation_df.RDA")
} else {
    source("src/removing_data_points_simulation.R")
}
